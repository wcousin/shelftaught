...
router.post('/curricula', asyncHandler(async (req: Request, res: Response) => {
  ...
  const curriculum = await prisma.curriculum.create({
    data: {
      ...
      materialsComponents: JSON.stringify(materialsComponents || []),
      ...
      availabilityInPrint: availabilityInPrint !== false ? 1 : 0,
      availabilityDigital: availabilityDigital === true ? 1 : 0,
      availabilityUsedMarket: availabilityUsedMarket === true ? 1 : 0,
